...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Input Surat Ucapan Terimakasih</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="codrops-top">
                <a href="#">
                    <strong>&laquo;FIK UDINUS: </strong>Pembuatan Surat Ucapan Terimakasih
                </a>
                <span class="right">
                    <a href="../index.php">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
						  <form name="form1" method="post" action="../berhasil.html" autocomplete="on"> 
                                <h1> Surat Ucapan Terimakasih</h1>
                                <p> 
                                    <label for="emailsign" class="youmail">Lampiran</label>
                                    <select name="lampiran" id="lampiran" class="cap" required>
                                        <option value="">Jumlah Lampiran</option>
                                        <option value="1 (satu) eksemplar">1 (satu) eksemplar</option>
                                        <option value="2 (dua) eksemplar">2 (dua) eksemplar</option>
                                    </select>
                                </p>
                                 <p> 
                                ...
                                <p> 
                                    <label for="emailsign" class="youmail">Judul Proyek</label>
                                    <input id="judul_proyek" name="judul_proyek" required="required" type="text" class="cap"  /> 
                                </p>
                                <p> 
                                    <label for="emailsign" class="youmail">Waktu</label>
                                    <input id="waktu" name="waktu" required="required" type="text" class="cap"  /> 
                                </p>
